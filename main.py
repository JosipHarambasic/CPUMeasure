...
plt.axvline(x=15, linestyle="dashed", color="red", label="start attack")
plt.axvline(x=25, linestyle="dashed", color="purple", label="network tracking")
plt.axvline(x=85, linestyle="dashed", color="green", label="attack killed")
plt.xlabel("seconds")
plt.legend()
